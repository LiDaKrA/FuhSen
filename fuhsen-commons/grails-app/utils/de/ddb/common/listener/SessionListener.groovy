...
class SessionListener implements HttpSessionListener {
    ...
    void sessionCreated(HttpSessionEvent event) {
        ...
        def configurationService = grailsApplication.getMainContext().getBean("configurationService")
...
//		}
        ...
        log.info "sessionDestroyed(): A session was destroyed. Total session count on node: " + totalSessionCount
    }
}
